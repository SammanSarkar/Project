...
function algo_change(algo){
  if(algo == 0){
   ...
   document.getElementById("select_algo").innerHTML = "<div class=\"box\"><a href=\"path/dijkstra.html\" ><h2>Dijkstra </h2></a></div><div class=\"box\"><a href=\"path/bfs.html\" ><h2>BFS</h2></a></div><div class=\"box\"><a href=\"path/dfs.html\" ><h2>DFS</h2></a></div>";
   boxes = document.querySelectorAll(".box");
   checkBoxes() ; 
  }
}
